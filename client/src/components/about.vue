  ...
  <div class="about" @click="toggle">
    <div class="window">
      <div class="loading" v-if="loading">
        <div class="logo">
        <img style="left: -9px;position: relative;" src="@/assets/images/logo.svg" alt="noFace" />
        <span style="left: -15px;position: relative;"><b>no</b>Face</span>
        </div>
        <div class="loader">
...
<script lang="ts">
  ...
  export default class extends Vue {
    ...
    async Load() {
      ...
      try {
        const res = await this.$http.get<string>('https://raw.githubusercontent.com/Glados95/neko/master/docs/README.md')
